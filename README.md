# Starter Kit for [Building Application in React With Redux]

1. **Install [Node 16](https://nodejs.org)**
...
| @wojtekmaj/enzyme-adapter-react | Configure Enzyme to work with React                              |
